...
<div class="container">
  ...
  <form id="create-form" action="<?= $BASE_URL ?>config/process.php" method="POST">
    ...
    <div class="form-group">
      <label for="obsevations">Observações:</label>
      <textarea type="text" class="form-control" id="obsevations" name="obsevations" placeholder="insira as Observações" rows="3"><?= $contact['observations'] ?> </textarea>
    </div>
